...
Use the sliders to select the severity of each symptom, and add optional notes or descriptions. Download your inputs as a CSV file for further tracking or sharing with a healthcare provider.
""")
...
input_df = pd.DataFrame([
    {"Symptom": symptom, "Severity": severity_map[data["Severity"]], "Notes": data["Notes"]}
    for symptom, data in input_data.items()
])
